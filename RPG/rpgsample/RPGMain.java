package java2021later.rpgsample;
import java.util.Random;
import java.util.Scanner;

import java2021later.rpgsample.rpgcreature.*;
...
public class RPGMain {
    ...
    public void game(){
        ...
        //メインループ（無限ループ）
        while(true){
            System.out.println("========"+BATTLE_TURN+"ターン目=========");
            //現在の状態を表示
            dispStatus();
            //入力されたコマンドを取得
            ...
            if(command == 1 || command == 2){
                ...
                System.out.println("1又は2を入力して下さい");
                command = sc.nextInt();
                if( command == COMMAND_BATTLE ){
                    //たたかう
                    if( !battle() ){
